...
import {
  ...
  IS_READ_TRUE_LOADING, IS_READ_TRUE_SUCCESS, IS_READ_TRUE_FAILURE,
...
function* watchLoadNotification() {
  yield takeLatest(LOAD_USER_NOTIFICATION_REQUEST, loadNotification);
}
function* watchIsReadTrue() {
  yield takeLatest(IS_READ_TRUE_LOADING, isReadTrue);
}
