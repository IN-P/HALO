  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        ...
        {
          role: 'user',
          content: `${teamname} 응원팀 팬에게 어울리는 짧고 인상적인 닉네임을 3개만 추천해줘. 한글 닉네임으로 공백은 _(언더바)로 대체, 너무 유치하지 않게, 해당 야구팀의 특색에 맞게 추천해 ex) ssg랜더스 : 홈런공장, output은 추천 닉네임 3개, 응원팀이 없다면 랜덤닉네임으로` ,
        },
      ],
    });
